...
?>
<div id="play">
<form action="<?php echo $view['router']->generate('_play2d') ?>" method="post" <?php echo $view['form']->enctype($form) ?> >
	<p><strong>Hi <font color='red'><?php echo $view['session']->get('name')?></font>! you are guessing in 2 dimension</strong><br>
    ...
    <td><strong>Low Y</strong></td><td><strong>High Y</strong></td></tr>
     <tr><td valign="top">
